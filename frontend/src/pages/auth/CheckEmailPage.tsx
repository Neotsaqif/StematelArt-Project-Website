...
export function CheckEmailPage() {
  ...
  const email = searchParams.get("email") || app.params?.email || "nama@email.com";
    ...
    <AuthSplit art={AUTH_ART.reset}>
      <div className="text-center">
        ...
        <p className="text-xs text-[#52525B] mt-4">
          <button onClick={() => app.navigate("login")} data-goes-to="→ Masuk" className="font-bold text-[#C41A22] hover:underline">
            Kembali ke Masuk
          </button>
        </p>
      </div>
