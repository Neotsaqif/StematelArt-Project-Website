...
export function WmSlider({ label, value, min, max, unit, onChange }: WmSliderProps) {
  return (
    <div>
...
export function WatermarkStudio({
  photoId = "1478760329108-5c3ed9d495a0",
  fileName = "kegelapan-abadi.png",
  onSkip,
  onApply,
  mode: footerMode = "flow"
